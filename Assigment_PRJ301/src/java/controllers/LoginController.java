...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Cookies
            Cookie idC = new Cookie("CookiesUserID", userID);
            Cookie passC = new Cookie("CookiesPassword", password);
            Cookie rememC = new Cookie("CookiesRemember", remember);
            if (remember != null) {
                idC.setMaxAge(60 * 60 * 24 * 30);
                passC.setMaxAge(60 * 60 * 24 * 30);
                rememC.setMaxAge(60 * 60 * 24 * 30);
            } else {
                idC.setMaxAge(0);
                passC.setMaxAge(0);
                rememC.setMaxAge(0);
